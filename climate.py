...
# 修改导入方式，引用本地重命名后的库
from .zhong_hong_b17_hvac.hub import ZhongHongGateway
from .zhong_hong_b17_hvac.hvac import HVAC as ZhongHongHVAC
...
SIGNAL_DEVICE_ADDED = "ZhongHongB17Lan_device_added"
SIGNAL_ZHONG_HONG_HUB_START = "ZhongHongB17Lan_hub_start"
...
def setup_platform(
    ...
    _LOGGER.debug("We got %s ZhongHongB17Lan climate devices", len(devices))
    ...
    async def startup():
        ...
        _LOGGER.debug("ZhongHongB17Lan hub start listen event")
...
class ZhongHongClimate(ClimateEntity):
    ...
    def __init__(self, hub, addr_out, addr_in):
        ...
        self._attr_unique_id = f"ZhongHongB17Lan_hvac_{addr_out}_{addr_in}"  # pylint: disable=home-assistant-entity-unique-id-redundant-domain
